package com.cinebook.paymentservice.exception;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiErrorResponse> handleNotFound(PaymentNotFoundException exception, WebRequest request) {
